...
ServerEvents.recipes(event => {
    ...
    millstone('#create:stone_types/veridium', [Item.of('create:crushed_raw_copper').withChance(0.5), Item.of('create:copper_nugget').withChance(0.5), Item.of('aether_redux:veridium_nugget').withChance(0.05)])
    crushingWheel('#create:stone_types/veridium', [Item.of('create:crushed_raw_copper').withChance(0.8), Item.of('create:copper_nugget').withChance(0.8), Item.of('aether_redux:veridium_nugget').withChance(0.1)])
    millstone('architects_palette:onyx', [Item.of('samurai_dynasty:onyx').withChance(0.25)])
    crushingWheel('architects_palette:onyx', [Item.of('samurai_dynasty:onyx').withChance(0.25)])
    millstone('quark:shale', [Item.of('create:crushed_raw_silver').withChance(0.5), Item.of('galosphere:silver_nugget').withChance(0.5)])
    crushingWheel('quark:shale', [Item.of('create:crushed_raw_silver').withChance(0.8), Item.of('galosphere:silver_nugget').withChance(0.8)])
    millstone('architects_palette:nebulite', [Item.of('forbidden_arcanus:arcane_crystal_dust').withChance(0.5), Item.of('forbidden_arcanus:arcane_crystal_dust_speck').withChance(0.5)])
    crushingWheel('architects_palette:nebulite', [Item.of('forbidden_arcanus:arcane_crystal_dust').withChance(0.8), Item.of('forbidden_arcanus:arcane_crystal_dust_speck').withChance(0.8)])
    ...
    millstone('minecraft:tuff', [Item.of('minecraft:flint').withChance(0.25), Item.of('minecraft:iron_nugget').withChance(0.1), Item.of('minecraft:gold_nugget').withChance(0.1), Item.of('create:zinc_nugget').withChance(0.1), Item.of('create:copper_nugget').withChance(0.1)])
    millstone('minecraft:diorite', [Item.of('minecraft:quartz').withChance(0.25)])
    ...
    millstone('#create:stone_types/ochrum', [Item.of('create:crushed_raw_gold').withChance(0.1), Item.of('minecraft:gold_nugget').withChance(0.1)])
    millstone('#create:stone_types/crimsite', [Item.of('create:crushed_raw_iron').withChance(0.2), Item.of('minecraft:iron_nugget').withChance(0.2)])
    millstone('#create:stone_types/asurine', [Item.of('create:crushed_raw_zinc').withChance(0.15), Item.of('create:zinc_nugget').withChance(0.15)])
