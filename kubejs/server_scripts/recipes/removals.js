...
ServerEvents.recipes(event => {
    ...
    */
    ...
    event.remove([{id: 'ae2:network/blocks/pattern_providers_interface_part'}, {id: 'ae2:network/blocks/pattern_providers_interface_alt'}])
    event.remove({id: 'ae2:network/blocks/pattern_providers_interface'})
    event.remove({id: 'create:milling/compat/ae2/ender_pearl'})
    event.remove([{id: 'ae2:network/parts/import_bus'}, {id: 'ae2:network/parts/export_bus'}])
    event.remove({id: 'ae2:network/blocks/energy_vibration_chamber'})
    event.remove([{id: 'ae2:network/parts/terminals_pattern_encoding'}, {id: 'ae2:network/parts/terminals_pattern_access'}])
    event.remove([{output: 'ae2:formation_plane'}, {output: 'ae2:annihilation_plane'}])
    event.remove({id: 'ae2:network/crystal_resonance_generator'})
    event.remove([{id: 'ae2:network/blocks/quantum_link'}, {id: 'ae2:network/blocks/quantum_ring'}])
    event.remove({type: 'minecraft:crafting_shaped', input: 'ae2:cell_component_1k'})
    event.remove({type: 'minecraft:crafting_shaped', input: 'ae2:cell_component_4k'})
    event.remove({type: 'minecraft:crafting_shaped', input: 'ae2:cell_component_16k'})
    event.remove({type: 'minecraft:crafting_shaped', input: 'ae2:cell_component_64k'})
    event.remove({type: 'minecraft:crafting_shaped', input: 'ae2:cell_component_256k'})
    event.remove({type: 'minecraft:crafting_shaped', input: 'ae2:spatial_cell_component_2'})
